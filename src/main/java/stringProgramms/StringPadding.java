...
There are many methods to pad a String:
    ...
    Using Apache Common Lang: Apache Commons Lang package stringProgramms the StringUtils class, which contains the leftPad(), center() and rightPad() method to easily left pad, center pad and right pad a String respectively.
